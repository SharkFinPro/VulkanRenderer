...
std::unique_ptr<VkPipelineColorBlendStateCreateInfo> TorusDisplayColorPipeline::defineColorBlendState()
{
...
std::unique_ptr<VkPipelineDepthStencilStateCreateInfo> TorusDisplayColorPipeline::defineDepthStencilState()
{
...
std::unique_ptr<VkPipelineDynamicStateCreateInfo> TorusDisplayColorPipeline::defineDynamicState()
{
  dynamicStates = {
...
std::unique_ptr<VkPipelineInputAssemblyStateCreateInfo> TorusDisplayColorPipeline::defineInputAssemblyState()
{
...
std::unique_ptr<VkPipelineMultisampleStateCreateInfo> TorusDisplayColorPipeline::defineMultisampleState()
{
...
std::unique_ptr<VkPipelineRasterizationStateCreateInfo> TorusDisplayColorPipeline::defineRasterizationState()
{
...
std::unique_ptr<VkPipelineVertexInputStateCreateInfo> TorusDisplayColorPipeline::defineVertexInputState()
{
...
std::unique_ptr<VkPipelineViewportStateCreateInfo> TorusDisplayColorPipeline::defineViewportState()
{
