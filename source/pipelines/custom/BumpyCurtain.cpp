...
void BumpyCurtain::render(const RenderInfo* renderInfo, const std::vector<std::shared_ptr<RenderObject>>* objects)
{
...
void BumpyCurtain::createUniforms(const VkCommandPool& commandPool)
{
  ...
  curtainUniform = std::make_unique<UniformBuffer>(logicalDevice, physicalDevice, logicalDevice->getMaxFramesInFlight(),
