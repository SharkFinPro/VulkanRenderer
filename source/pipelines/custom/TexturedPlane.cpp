...
VkDescriptorSetLayout TexturedPlane::getLayout() const
{
...
std::unique_ptr<VkPipelineColorBlendStateCreateInfo> TexturedPlane::defineColorBlendState()
{
...
std::unique_ptr<VkPipelineDepthStencilStateCreateInfo> TexturedPlane::defineDepthStencilState()
{
...
std::unique_ptr<VkPipelineDynamicStateCreateInfo> TexturedPlane::defineDynamicState()
{
  dynamicStates = {
...
std::unique_ptr<VkPipelineInputAssemblyStateCreateInfo> TexturedPlane::defineInputAssemblyState()
{
...
std::unique_ptr<VkPipelineMultisampleStateCreateInfo> TexturedPlane::defineMultisampleState()
{
...
std::unique_ptr<VkPipelineRasterizationStateCreateInfo> TexturedPlane::defineRasterizationState()
{
...
std::unique_ptr<VkPipelineVertexInputStateCreateInfo> TexturedPlane::defineVertexInputState()
{
...
std::unique_ptr<VkPipelineViewportStateCreateInfo> TexturedPlane::defineViewportState()
{
...
void TexturedPlane::createDescriptorSetLayouts()
{
...
void TexturedPlane::createObjectDescriptorSetLayout()
{
...
void TexturedPlane::createDescriptorPool()
{
