...
std::unique_ptr<VkPipelineColorBlendStateCreateInfo> NoisyEllipticalDots::defineColorBlendState()
{
...
std::unique_ptr<VkPipelineDepthStencilStateCreateInfo> NoisyEllipticalDots::defineDepthStencilState()
{
...
std::unique_ptr<VkPipelineDynamicStateCreateInfo> NoisyEllipticalDots::defineDynamicState()
{
  dynamicStates = {
...
std::unique_ptr<VkPipelineInputAssemblyStateCreateInfo> NoisyEllipticalDots::defineInputAssemblyState()
{
...
std::unique_ptr<VkPipelineMultisampleStateCreateInfo> NoisyEllipticalDots::defineMultisampleState()
{
...
std::unique_ptr<VkPipelineRasterizationStateCreateInfo> NoisyEllipticalDots::defineRasterizationState()
{
...
std::unique_ptr<VkPipelineVertexInputStateCreateInfo> NoisyEllipticalDots::defineVertexInputState()
{
...
std::unique_ptr<VkPipelineViewportStateCreateInfo> NoisyEllipticalDots::defineViewportState()
{
